...
class Screen5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        QuizManegement.context = this@Screen5
        ...
        questionTextView5.text = question.question.toString()


        radioButton1Screen5.text = question.option1
        radioButton2Screen5.text = question.option2
        radioButton3Screen5.text = question.option3
        radioButton4Screen5.text = question.option4

        buttonAnswer5.setOnClickListener {
            if (radioGroup5.checkedRadioButtonId == -1) {
                toast(R.string.noneRadioSelected)
            } else {
                buttonNext5.visibility = View.VISIBLE
                buttonAnswer5.visibility = View.INVISIBLE
                val id = radioGroup5.checkedRadioButtonId
    ...
    fun getScore() {
        textViewScore5.text = QuizManegement.showScore().toString()
    }
